          ...
          <div className="p-4 border-t border-sidebar-border">
            <div className="flex items-center">
              <Avatar className="h-9 w-9">
                <AvatarImage src="" alt="Restaurant" />
                <AvatarFallback className="bg-primary">RS</AvatarFallback>
              </Avatar>
              <div className="ml-3">
                <p className="text-sm font-medium text-sidebar-foreground">Gourmet Bistro</p>
                <p className="text-xs text-sidebar-foreground/70">bistro@example.com</p>
              </div>
            </div>
        ...
        <header className="h-16 flex items-center justify-between px-6 border-b border-border bg-background">
          ...
          <div className={`${!isMobile ? 'ml-auto' : ''}`}>
            <p className="text-sm text-muted-foreground">
              Welcome back, <span className="font-medium text-foreground">Gourmet Bistro</span>
            </p>
          </div>
        </header>
